...
Tracking track = Tracking(0x0dcd2f752394c41875e259e00bb44fd505297caf);
address admin;
...
// function to remove supplier from database (can only be done byadmin)
...
{
    return (suppliers[_supplier].name,suppliers[_supplier]._phoneNo,suppliers[_supplier].cityState,suppliers [_supplier].country,suppliers [_supplier]goodsType,suppliers [_supplier].reputation);
...
// function to search for suppliers by reputation (returns thosen with same or higher reputation)
